...
# Create tabs
tab1, tab2, tab3, tab4 = st.tabs(["EV Trends", "EVs with top range by year and category", "EV charging stations map", "EV registrations By region"])
...
# Content for Tab 4
with tab4:
    st.header("EV Registrations By Climate Region")
