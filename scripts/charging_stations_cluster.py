...
def run():
    ...
    response = requests.get(f"https://developer.nrl.gov/api/alt-fuel-stations/v1?api_key={key}&format=csv&status=E&fuel_type=ELEC&access=public&country=US&ev_connector_type=J1772,J1772COMBO")
